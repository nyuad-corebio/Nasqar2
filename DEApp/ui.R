...
sidebar <- dashboardSidebar(
    ...
    helpText("Developed by the ", a("bioinformatics core, ", href = "http://cri.uchicago.edu/bioinformatics/"),
        a("Center for Research Informatics (CRI), ", href = "http://cri.uchicago.edu/"), "University of Chicago",
...
body <- dashboardBody(
    tabItems(
        ...
        tabItem(
            ...
            h2("Feedback"),
            p(
                "This App is developed and maintained by Yan Li at the",
        ...
        tabItem(
            tabName = "dataInputSingle",
            fluidRow(
                box(
                    title = "Input data: Single-factor Experiment",
            ...
            fluidRow(
                box(
                    title = "Input Information Summary",
            ...
            fluidRow(
                ...
                box(
                    title = "Sample Group Information Summary",
                    solidHeader = T, status = "success",
                    # background = "green",
                    width = 6,
        ...
        tabItem(
            tabName = "dataInputMulti",
            fluidRow(
                box(
                    title = "Input data: Multi-factor Experiment",
                    solidHeader = T, status = "info",
                    collapsible = T, collapsed = F,
                    width = 12,
                    fluidRow(
                        ...
                        box(
                            ...
                            helpText(
                                HTML("<div style=\"color: black \">An example of full 'Raw Count Data' csv file for the multi-factor experiment is accessible "),
        ...
        tabItem(
            ...
            fluidRow(
                box(
                    ...
                    fluidRow(
                        ...
                        box(
                            title = "Low Expression Removal Options",
                            solidHeader = T, status = "info",
                            width = 2,
                        ...
                        box(
                            title = "After Low Expression Removal",
                            # background = "green",
                            solidHeader = T, status = "success",
                            width = 5,
                            fluidRow(
            ...
            fluidRow(
                ...
                box(
                    title = "Sample Normalization Results",
                    solidHeader = T, status = "success",
                    width = 6,
        ...
        tabItem(
            ...
            fluidRow(
                box(
                    title = "edgeR DE Analysis Options",
                    solidHeader = T, status = "info",
                    collapsible = T, collapsed = F,
                    width = 12,
                    fluidRow(
                        ...
                        box(
                            title = "DE Analysis Group Levels",
                        ...
                        box(
                            title = "DE Analysis Filtering Criteria",
                            width = 8,
                            solidHeader = T,
                            status = "info",
                            fluidRow(
        ...
        tabItem(
            ...
            fluidRow(
                box(
                    title = "Limma-voom DE Analysis Options",
                    solidHeader = T, status = "info",
                    collapsible = T, collapsed = F,
                    width = 12,
                    fluidRow(
        ...
        tabItem(
            ...
            fluidRow(
                box(
                    title = "DESeq2 DE Analysis Options",
                    solidHeader = T, status = "info",
                    collapsible = T, collapsed = F,
                    width = 12,
                    fluidRow(
        ...
        tabItem(
            ...
            fluidRow(
                box(
                    title = "DE Analysis Comparison Options",
                    solidHeader = T, status = "info",
                    collapsible = T, collapsed = F,
                    width = 12,
                    fluidRow(
