...
tagList(
    tags$head(
        ...
        useShinyjs(),
        extendShinyjs(text = jsCode, functions = c("changeWidthHeatmap"))
    ),
    navbarPage(
        id = "navbarpageid",
        ...
        ## ==================================================================================== ##
        footer = p(
            hr(), p("ShinyApp created by ", strong("{Jessica Minnier + Jiri Sklenar + Jonathan Nelson}"), " of ", align = "center", width = 4),
