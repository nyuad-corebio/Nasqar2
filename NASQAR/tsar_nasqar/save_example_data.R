...
write.csv(seqdatascr, "www/exampleData/mousecounts_example.csv", row.names = FALSE)

seqdata <- read.csv("www/exampleData/mousecounts_example.csv", stringsAsFactors = FALSE)
numgeneids <- 2
...
save(countdata, group_names, sampledata, results, data_long, geneids, expr_data,
    file = "www/exampleData/mousecounts_example_analysis_results.RData"
)
...
save(example_data_results, file = "www/exampleData/mousecounts_example_analyzed.RData")
write.csv(example_data_results, file = "www/exampleData/mousecounts_example_analyzed.csv", quote = FALSE, row.names = FALSE)

write.csv(example_data_results[1:100, ], file = "www/exampleData/exampleanalysisres_short.csv", quote = FALSE, row.names = FALSE)
write.csv(seqdata[1:100, ], "www/exampleData/examplecounts_short.csv", row.names = FALSE)
