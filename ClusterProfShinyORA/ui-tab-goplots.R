tabItem(
    ...
    tags$div(
        box(
            title = "Upset Plot", solidHeader = T, status = "danger", width = 12, collapsible = T, id = "barplot",
            fluidRow(
                column(
                    3,
                    wellPanel(
        ...
        box(
            title = "Bar Plot", solidHeader = T, status = "danger", width = 12, collapsible = T, id = "barplot",
            fluidRow(
                column(
                    3,
                    wellPanel(
        ...
        box(
            title = "Encrichment plot map", solidHeader = T, status = "danger", width = 12, collapsible = T, id = "enrichPlotMap",
            fluidRow(
                column(
                    3,
                    wellPanel(
        ...
        box(
            title = "Category Netplot", solidHeader = T, status = "danger", width = 12, collapsible = T, id = "goInducedGraph",
            fluidRow(
                column(
                    12,
                    wellPanel(
        ...
        box(
            title = "Enriched GO induced graph (cnetplot)", solidHeader = T, status = "danger", width = 12, collapsible = T, id = "cnetplot",
            fluidRow(
                column(
                    12,
                    wellPanel(
