...
ui <- tagList(
    ...
    tags$footer(
        ...
        <p align="center" width="4">Github: <a href="https://github.com/nyuad-corebio/Nasqar2/ClusterProfShiny/">https://github.com/nyuad-corebio/Nasqar2/ClusterProfShiny/</a></p>
