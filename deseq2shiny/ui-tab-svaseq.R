    ...
    fluidRow(
        column(
            ...
            wellPanel(
                ...
                p("For more information, see following ", a("link", target = "_blank", href = "https://bioconductor.org/packages/release/workflows/vignettes/rnaseqGene/inst/doc/rnaseqGene.html#using-sva-with-deseq2"))
            ),
            box(
                title = "Estimate Surrogate Variables (SVA)", width = 12, solidHeader = T, status = "primary",
                column(
                    6,
            ...
            conditionalPanel(
                ...
                box(
                    title = "Remove Batch Effect (PCA Visualization)", width = 12, solidHeader = T, status = "primary",
