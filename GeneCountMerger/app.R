                            ...
                            conditionalPanel(
                                ...
                                wellPanel(
                                    ...
                                    conditionalPanel(
                                        ...
                                        a(href = "https://github.com/nyuad-corebio/Nasqar2/GeneidToNameFromGtf", "Click here if you have a .gtf file for your genome", target = "_blank"),
                                    ...
                                    tags$ul(
                                        ...
                                        tags$li(
                                            ...
                                            tags$ul(
                                                ...
                                                tags$li("If genome/version is not available in the options and you have a ", a(target = "_blank", href = "https://asia.ensembl.org/info/website/upload/gff.html", ".gtf"), " file for your genome", a(href = "https://github.com/nyuad-corebio/Nasqar2/GeneidToNameFromGtf", "follow these instructions."))
                                            )
                                        ),
